...
\begin{itemize}
	\item \textbf{GOOGLE\_API\_KEY:} clave obtenida anteriormente necesaria para obtener datos de Google.
	\item \textbf{SECRET\_KEY:} clave necesaria por Flask.
	\item \textbf{ENVIRORMENT:} en el que se está actualmente: development o production.
\end{itemize}
