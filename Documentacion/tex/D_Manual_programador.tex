...
Cruza la referencia con la Figura de abajo <<instalar PyCharm D.1>> y no termino de entender muy bien por qué.
...
Para el control de versiones se ha utilizado GitCraken.
...
Tras varias pruebas, la instalación y ejecución del proyecto es idéntica salvo la propia instalción de Pycharm y Python.
¿Me extiendo un poco más? La ejecución y configuración del entorno es exactamente igual dentro de PyCharm.
