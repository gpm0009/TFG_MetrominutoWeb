...
En los orígenes de este sistema de movilidad se encuentra el estudio, por medio de la técnica DAFO(¿cita?) (Debilidades, Amenazas, Fortalezas, Oportunidades):
...
\end{description}
Estos planos no solo nos incitan a caminar, so no que también incluyen información útil acerca de líneas de autobús, estaciones de ferrocarril o de metro \dots
...
\begin{enumerate}
	...
	\item Paso 2: Decidir que ruta \textbf{peatonal} es la mas adecuado para unirlos.
...
Realizó varias versiones antes de llegar a la que conocemos hoy en día, como por ejemplo las que podemos observar en las siguientes imágenes.
