...
\begin{steps}
	\item Consiste en la selección, dentro de una ciudad, de los puntos los cuales se quieren representar en el mapa. Estos puntos pueden elegirse en función de su importancia, interés turístico o de los ciudadanos.
	\item Decidir qué ruta \textbf{peatonal} es la mas adecuada para unirlos.
	...
	\item Reflejar accidentes naturales o elementos de la ciudad como parques, mar, ríos\dots A través de elementos muy sencillos y con un código de colores al que estamos acostumbrados.
	...
	\item No sólo mostrar conexiones con el punto central establecido como referencia, si no que también debe aparecer información sobre la interconexión entre los diferentes puntos.
\end{steps}
