...
\subsection{Flask}
Flask es un framework de Python que nos permite crear aplicaciones cliente - servidor de una manera mas sencilla y empleando un mínimo número de lineas para ello. Ofrece servicios HTTP, pero para poder hacer uso de los contenidos HTML requiere de la utilización del motor de templates \textit{Jinja2}: lenguaje de plantillas que permite insertar datos procesados y texto predeterminado.
