...
\\
Ofrece servicios HTTP, pero para poder hacer uso de los contenidos HTML requiere de la utilización del motor de templates \textit{Jinja2}.
\\
Lenguaje de plantillas que permite insertar datos procesados y texto predeterminado.
