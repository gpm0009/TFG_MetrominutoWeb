...
\tablaSmallSinColores{Costes de personal.}{l l l}{personal}{
	\textbf{Concepto} & \textbf{Devengos(\EUR{}){}} & \textbf{Deducciones(\EUR{}){}}\\
}
{
...
Además, sumar el coste de los dos tutores asignados al proyecto durante los 9 meses de duración del mismo, en los que se realizaron veinticinco sprints (ver sección \nameref{sec:planificacion-temporal}), que será de \EUR{50,00}/hora (ver tabla~\ref{tabla:tutores}).

\tablaSmallSinColores{Costes de tutores.}{l l l l}{tutores}{
	\textbf{Concepto} & \textbf{Precio unitario(\EUR{}/hora){}} & \textbf{Cantidad(horas){}} &  \textbf{Total(\EUR{}){}}\\
}
{
...
\tablaSmallSinColores{Costes de hardware.}{l l l}{hardware}{
	\textbf{Concepto} & \textbf{Coste(\EUR{}){}} & \textbf{Amortización(\EUR{}){}}\\
}
{
...
\tablaSmallSinColores{Costes de software.}{l l}{software}{
...
\tablaSmallSinColores{Coste Azure}{l p{5cm} l}{costes-azure}{
	\textbf{Concepto} & \textbf{Valor{}} & \textbf{Coste{}}\\
}
{
	Región & Europa Oeste &  \\
...
\tablaSmallSinColores{Coste Google API}{l l l}{google-api-costes}{
	\textbf{Concepto} & \textbf{Coste(\EUR{}){}/1000 solicitudes}\\
}
{
