...
Durante este Sprint, las tareas u objetivos fuero:
\begin{itemize}
...
\end{itemize}
Durante es Sprint se encontraron varias dificultades en calcular la superposición, por lo que quedaron pendientes esta tarea, junto con la del cálculo de los SVG.
